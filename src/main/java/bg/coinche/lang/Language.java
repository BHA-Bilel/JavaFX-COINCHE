...
public class Language {
    ...
    public static StringProperty
            ...
            LOCAL, ONLINE,
            RETRY, CANCEL, OK, ACCEPT, PREVIOUS, NEXT, DONE, REFUSE,
    ...
    GEN_SH_T, GEN_SH_H, GEN_SH_C,
            ...
            TEAM_UP, TU_H1, TU_C1, TU_H2, TU_C2, TU_C3, TU_C4,
            G_SH_T, G_SH_H, G_SH_C,
            VIEW_SC, CURRENT_SC, GR_H,
            YOU_WON, YOU_LOST, TOTAL_PT_WON,
            YOUR_PTS, OP_PTS,
            YOUR_TEAM, OP_TEAM,
            END_GAME, GE_H, GE_C,
    ...
    COINCHE_2, COINCHE_4, COINCHER, SURCOINCHER, DEALER,
            NT, AT, HEARTS, SPADES, DIAMONDS, CLUBS, PASS, CAPOT, BUY,
            SAY_ATOUT, SAY_COUPE, SAY_MONTE, SAY_MAITRE, SAY_PISS, BELOTE, REBELOTE,
            PTS_CONT_FAIL_H, PTS_CONT_FAIL_C1, PTS_CONT_FAIL_C2, CONTRACT_OUT_OF_RANGE, CAPOT_MORE_PTS,
            JACK_CARRE, NINE_CARRE, CARRE, SUITE, ANNONE, TIERCE,
            YOU, THEM, CONTRACT, PLAYED_CAPOT, PTS_DONE, TOTAL_PTS_DONE, DECLARATIONS,
            TOTAL, RESULT, FAILED, WON, REASONS, REASONS_1, REASONS_2, REASONS_3,
            DEFENDER_CAPOT, COINCHE_WIN_BONUS, COINCHE_FAIL_PENALTY, CONTRACT_FAIL_PENALTY,
            LOSER_GET_NOTHING, PTS_CALCULATION, ROUND_TOTAL, MATCH_TOTAL;
    ...
    public static void init() {
        ...
        TEAM_UP = new SimpleStringProperty();
        TU_H1 = new SimpleStringProperty();
        TU_C1 = new SimpleStringProperty();
        TU_H2 = new SimpleStringProperty();
        TU_C2 = new SimpleStringProperty();
        TU_C3 = new SimpleStringProperty();
        TU_C4 = new SimpleStringProperty();
        ...
        REFUSE = new SimpleStringProperty();
        ...
        REASONS_1 = new SimpleStringProperty();
        REASONS_2 = new SimpleStringProperty();
        REASONS_3 = new SimpleStringProperty();
        YOU_WON = new SimpleStringProperty();
        YOU_LOST = new SimpleStringProperty();
        YOUR_PTS = new SimpleStringProperty();
        OP_PTS = new SimpleStringProperty();
        CURRENT_SC = new SimpleStringProperty();
        TOTAL_PT_WON = new SimpleStringProperty();
        YOUR_TEAM = new SimpleStringProperty();
        OP_TEAM = new SimpleStringProperty();
        ...
        COINCHE_2 = new SimpleStringProperty();
        COINCHE_4 = new SimpleStringProperty();
        COINCHER = new SimpleStringProperty();
        SURCOINCHER = new SimpleStringProperty();
        DEALER = new SimpleStringProperty();
        NT = new SimpleStringProperty();
        AT = new SimpleStringProperty();
        HEARTS = new SimpleStringProperty();
        SPADES = new SimpleStringProperty();
        DIAMONDS = new SimpleStringProperty();
        CLUBS = new SimpleStringProperty();
        PASS = new SimpleStringProperty();
        CAPOT = new SimpleStringProperty();
        BUY = new SimpleStringProperty();
        SAY_ATOUT = new SimpleStringProperty();
        SAY_COUPE = new SimpleStringProperty();
        SAY_MONTE = new SimpleStringProperty();
        SAY_MAITRE = new SimpleStringProperty();
        SAY_PISS = new SimpleStringProperty();
        PTS_CONT_FAIL_H = new SimpleStringProperty();
        PTS_CONT_FAIL_C1 = new SimpleStringProperty();
        PTS_CONT_FAIL_C2 = new SimpleStringProperty();
        CONTRACT_OUT_OF_RANGE = new SimpleStringProperty();
        CAPOT_MORE_PTS = new SimpleStringProperty();
        JACK_CARRE = new SimpleStringProperty();
        NINE_CARRE = new SimpleStringProperty();
        CARRE = new SimpleStringProperty();
        SUITE = new SimpleStringProperty();
        ANNONE = new SimpleStringProperty();
        TIERCE = new SimpleStringProperty();
        BELOTE = new SimpleStringProperty();
        REBELOTE = new SimpleStringProperty();
        YOU = new SimpleStringProperty();
        THEM = new SimpleStringProperty();
        CONTRACT = new SimpleStringProperty();
        PLAYED_CAPOT = new SimpleStringProperty();
        PTS_DONE = new SimpleStringProperty();
        TOTAL_PTS_DONE = new SimpleStringProperty();
        DECLARATIONS = new SimpleStringProperty();
        TOTAL = new SimpleStringProperty();
        RESULT = new SimpleStringProperty();
        FAILED = new SimpleStringProperty();
        WON = new SimpleStringProperty();
        REASONS = new SimpleStringProperty();
        DEFENDER_CAPOT = new SimpleStringProperty();
        COINCHE_WIN_BONUS = new SimpleStringProperty();
        COINCHE_FAIL_PENALTY = new SimpleStringProperty();
        CONTRACT_FAIL_PENALTY = new SimpleStringProperty();
        LOSER_GET_NOTHING = new SimpleStringProperty();
        PTS_CALCULATION = new SimpleStringProperty();
        ROUND_TOTAL = new SimpleStringProperty();
        MATCH_TOTAL = new SimpleStringProperty();
    }
    ...
    public static StringProperty team_up(String from) {
        StringProperty team_up = new SimpleStringProperty();
        switch (LANG_NAME) {
            case ENGLISH:
                team_up.set(from + " wants to become your teammate!");
            case FRENCH:
                team_up.set(from + " veut devenir votre coéquipier !");
            case ARABIC:
                team_up.set("يريد " + from + " أن يصبح زميلك في الفريق!");
        }
        return team_up;
    }

    public static String table_placeholder() {
        switch (LANG_NAME) {
            case ENGLISH:
                return "Score history will be shown in this table";
            case ARABIC:
                return "سيتم عرض سجل النتائج في هذا الجدول";
            case FRENCH:
                return "L'historique de score sera affiché dans ce tableau";
            default:
                return "";
        }
    }
    ...
    private static void load_arabic_strings() {
        ...
        WELCOME_C.set("أهلا! أنا بن حاج عمار بلال ، مطور هذه اللعبة"
                + "\n"
                + "\n"
                + "لعبة بلوت الفرنسية الخاصة بي ليست لعبة عادية!"
                + "\n"
        ...
        G_SH_C.set("Ctrl + V" +
                "\nعرض النتيجة         "
                + "\n"
                + "\nTab (اضغط مع الاستمرار)"
                + "\nمرحلة الشراء: عرض النتيجة مع سجل الشراء         "
                + "\nمرحلة اللعب: عرض الطية السابقة         "
                + "\n"
                + "\nCtrl + E"
        ...
        DU_XO_H.set("تريد أن تلعب تيك تاك تو مع أصدقائك؟");
        DU_XO_C.set("قم بتنزيل لعبة تيك تاك تو الخاصة بي مجانًا");
        ...
        DU_COINCHE_H.set("تأكد أن لديك أحدث إصدار من بلوت الفرنسية");
        DU_COINCHE_C.set("نسختك الحالية هي: " + MainApp.CURRENT_VERSION + " ، تحقق من وجود إصدار جديد");
        ...
        YOU_WON.set("لقد فزت!");
        YOU_LOST.set("لقد خسرت!");
        YOUR_PTS.set("نقاطك: ");
        OP_PTS.set("نقاط الخصوم: ");
        CURRENT_SC.set("النتيجة الحالية");
        TOTAL_PT_WON.set("مجموع المباريات الفائزة: ");
        YOUR_TEAM.set("فريقك: ");
        OP_TEAM.set("فريق الخصم: ");
        ...
        TEAM_UP.set("إتحاد");
        TU_H1.set("لا يمكنك الإتحاد في الوقت الحالي");
        TU_C1.set("ليس لديك أي خصوم!");
        TU_H2.set("حدد اللاعب الذي تريد الإتحاد معه");
        TU_C2.set("سيتم إرسال طلب إتحاد إلى:");
        TU_C3.set(" رفض الاتحاد معك!");
        TU_C4.set("هل تريد الإتحاد معه ؟");
        ...
        CNT_SG_C2.set("أنت بحاجة إلى 4 أشخاص في الغرفة لبدء اللعبة");
        READY.set("حالة الاستعداد");
        COINCHE_2.set("إزدواج");
        COINCHE_4.set("تربيع");
        HEARTS.set("هاص");
        SPADES.set("سبيت");
        DIAMONDS.set("ديمن");
        ...
        NT.set("بدون حكم");
        AT.set("الكل حكم");
        PASS.set("إنهاء الدور");
        COINCHER.set("إزدواج!");
        SURCOINCHER.set("تربيع!");
        DEALER.set("الموزع");
        CAPOT.set("كبوت");
        BUY.set("الشراء");
        SAY_ATOUT.set("حكم");
        SAY_COUPE.set("اقطع");
        SAY_MONTE.set("اصعد");
        SAY_MAITRE.set("مسيطر");
        SAY_PISS.set("تنازل");
        BELOTE.set("بلوت");
        REBELOTE.set("رو بلوت");
        PTS_CONT_FAIL_H.set("النقاط اللازمة لفشل العقد");
        PTS_CONT_FAIL_C1.set("أكلة واحدة");
        PTS_CONT_FAIL_C2.set("أكلة واحدة، أو مشروع أعلى");
        CONTRACT_OUT_OF_RANGE.set("العقد خارج النطاق ، فزت!");
        CAPOT_MORE_PTS.set("كبوت أو مجموع نقاط أكثر");
        JACK_CARRE.set("أربع جونيور");
        NINE_CARRE.set("أربع تسعات");
        CARRE.set("أربعة من نوع");
        SUITE.set("مئة");
        ANNONE.set("خمسين");
        TIERCE.set("سرى");
        YOU.set("أنت");
        THEM.set("هم");
        CONTRACT.set("العقد");
        PLAYED_CAPOT.set("كبوت ملعوب");
        PTS_DONE.set("النقاط المحققة");
        TOTAL_PTS_DONE.set("مجموع النقاط المحققة");
        DECLARATIONS.set("المشاريع");
        TOTAL.set("المجموع");
        RESULT.set("النتيجة");
        FAILED.set("فشل");
        WON.set("فوز");
        REASONS.set("الأسباب");
        REASONS_1.set("لم يصل المشتري إلى النقاط المطلوبة!");
        REASONS_2.set("حصل المدافع على نقاط أكثر!");
        REASONS_3.set("فشل عقد كبوت!");
        DEFENDER_CAPOT.set("كبوت المدافع");
        COINCHE_WIN_BONUS.set("مكافأة الفوز المضاعف");
        COINCHE_FAIL_PENALTY.set("غرامة فشل المضاعفة");
        CONTRACT_FAIL_PENALTY.set("غرامة فشل العقد");
        LOSER_GET_NOTHING.set("الخاسر لا يحصل على شيء");
        PTS_CALCULATION.set("حساب النقاط");
        ROUND_TOTAL.set("مجموع الجولة");
        MATCH_TOTAL.set("مجموع المباراة");
    }
    ...
    private static void load_french_strings() {
        ...
        WELCOME_C.set("Salut! Je suis BENHADJ AMAR Bilel, le développeur de ce jeu"
                + "\n"
                + "\n"
                + "Mon jeu de coinche n'est pas un jeu ordinaire !"
                + "\n"
        ...
        G_SH_C.set("Ctrl + V" +
                "\n         Voir le score"
                + "\n"
                + "\nTab (Appuyez et maintenez)"
                + "\n         Phase d'achat : afficher le score avec l'historique des achats"
                + "\n         phase de jeu : voir le pli précédent"
                + "\n"
                + "\nCtrl + E"
        ...
        DU_XO_H.set("Voulez-vous jouer xo avec vos amis ?");
        DU_XO_C.set("Téléchargez mon jeu xo gratuitement");
        ...
        DU_COINCHE_H.set("Assurez-vous d'avoir la dernière version de coinche");
        DU_COINCHE_C.set("Votre version actuelle est : "
        ...
        YOU_WON.set("Vous avez gagné !");
        YOU_LOST.set("Vous avez perdu !");
        YOUR_PTS.set("Vos points : ");
        OP_PTS.set("Points de l'adversaire : ");
        CURRENT_SC.set("Score actuel");
        TOTAL_PT_WON.set("Nombre total de parties gagnées : ");
        YOUR_TEAM.set("Votre équipe : ");
        OP_TEAM.set("Équipe adversaire : ");
        ...
        TEAM_UP.set("Unir avec");
        TU_H1.set("Vous ne pouvez pas vous unir pour le moment");
        TU_C1.set("Vous n'avez pas d'adversaires !");
        TU_H2.set("Sélectionnez le joueur avec lequel vous souhaitez vous unir");
        TU_C2.set("Une demande d'union sera envoyée à :");
        TU_C3.set(" a refusé de s'unir à vous !");
        TU_C4.set("Aimeriez-vous qu'il/elle soit votre nouveau coéquipier ?");
        ...
        CNT_SG_C2.set("Vous avez besoin de 4 personnes dans la salle pour commencer le jeu");
        READY.set("Prêt");
        COINCHER.set("Coincher!");
        SURCOINCHER.set("Surcoincher!");
        DEALER.set("Dist.");
        CAPOT.set("Capot");
        BUY.set("Achat");
        SAY_ATOUT.set("Atout");
        SAY_COUPE.set("Je coupe");
        SAY_MONTE.set("Je monte");
        SAY_MAITRE.set("Maître");
        SAY_PISS.set("Je piss");
        BELOTE.set("Belote");
        REBELOTE.set("Rebelote");
        COINCHE_2.set("Coinche");
        COINCHE_4.set("Surcoinche");
        HEARTS.set("Coeur");
        SPADES.set("Pique");
        DIAMONDS.set("Carreau");
        CLUBS.set("Trèfle");
        NT.set("Sans atout");
        AT.set("Tout atout");
        PASS.set("Passe");
        PTS_CONT_FAIL_H.set("Points pour échouer le contrat");
        PTS_CONT_FAIL_C1.set("Un pli");
        PTS_CONT_FAIL_C2.set("Un pli, ou une déclaration supérieure");
        CONTRACT_OUT_OF_RANGE.set("Contrat hors de portée, vous gagnez !");
        CAPOT_MORE_PTS.set("Capot ou plus de points au total");
        JACK_CARRE.set("Carré valet");
        NINE_CARRE.set("Carré neuf");
        CARRE.set("Carré");
        SUITE.set("Suite");
        ANNONE.set("Annonce");
        TIERCE.set("Tierce");
        YOU.set("Vous");
        THEM.set("Eux");
        CONTRACT.set("Contrat");
        PLAYED_CAPOT.set("Capot Joué");
        PTS_DONE.set("Points fait");
        TOTAL_PTS_DONE.set("Total des points obtenus");
        DECLARATIONS.set("Declarations");
        TOTAL.set("Total");
        RESULT.set("Résultat");
        FAILED.set("Manqué");
        WON.set("Gagné");
        REASONS.set("Raison(s)");
        REASONS_1.set("L'acheteur n'a pas atteint les points d'enchère !");
        REASONS_2.set("Le défenseur a obtenu plus de points !");
        REASONS_3.set("Capot échoué !");
        DEFENDER_CAPOT.set("Capot de défenseur");
        COINCHE_WIN_BONUS.set("Bonus de coinche gagner");
        COINCHE_FAIL_PENALTY.set("Pénalité d'échec de coinche");
        CONTRACT_FAIL_PENALTY.set("Pénalité d'échec de contrat");
        LOSER_GET_NOTHING.set("Le perdant n'obtient rien");
        PTS_CALCULATION.set("Calcul des points");
        ROUND_TOTAL.set("Total de partie");
        MATCH_TOTAL.set("Total de match");
    }
    ...
    private static void load_english_strings() {
        ...
        WELCOME_C.set("Hi! I am BENHADJ AMAR Bilel, the developer of this game"
                + "\n"
                + "\n"
                + "My coinche game is no ordinary game!"
                + "\n"
                ...
                + "\n"
                + "\n"
                + "For the best experience, don't forget to check_declarations for updates from time to time"
                + "\n");
        ...
        G_SH_C.set("Ctrl + V" +
                ...
                + "\n"
                + "\nTab (Press and hold)"
                + "\n         Buy phase: view score history"
                + "\n         Play phase: View previous fold"
                + "\n"
                + "\nCtrl + E"
        ...
        DU_XO_H.set("Want to play xo with your friends?");
        DU_XO_C.set("Download my xo app for free");
        ...
        DU_COINCHE_H.set("Make sure you have the latest version of coinche");
        DU_COINCHE_C.set("Your current version is : " + MainApp.CURRENT_VERSION + ", Check for new version");
        ...
        YOU_WON.set("You won!");
        YOU_LOST.set("You lost!");
        YOUR_PTS.set("Your points: ");
        OP_PTS.set("Opponents points: ");
        CURRENT_SC.set("Current score");
        TOTAL_PT_WON.set("Total parties won: ");
        YOUR_TEAM.set("Your team: ");
        OP_TEAM.set("Opponent team: ");
        ...
        TEAM_UP.set("Team up");
        TU_H1.set("You can't team up at the moment");
        TU_C1.set("You don't have any opponents!");
        TU_H2.set("Select the player you want to team up with");
        TU_C2.set("A team up request will be sent to:");
        TU_C3.set(" has refused to team up with you!");
        TU_C4.set("Would you like him/her to be your new teammate?");
        ...
        CNT_SG_C2.set("You need 4 people in the room to start the game");
        READY.set("Ready");
        COINCHE_2.set("Coinche");
        COINCHE_4.set("Surcoinche");
        HEARTS.set("Hearts");
        ...
        SAY_ATOUT.set("Trump");
        SAY_COUPE.set("I cut");
        SAY_MONTE.set("I rise");
        SAY_MAITRE.set("Dominant");
        SAY_PISS.set("I yield");
        BELOTE.set("Belote");
        REBELOTE.set("Rebelote");
        PTS_CONT_FAIL_H.set("Points to fail contract");
        PTS_CONT_FAIL_C1.set("One fold");
        PTS_CONT_FAIL_C2.set("One fold, or a higher declaration");
        CONTRACT_OUT_OF_RANGE.set("Contract out of range, You win!");
        CAPOT_MORE_PTS.set("Capot or more total points");
        JACK_CARRE.set("Four jacks");
        NINE_CARRE.set("Four nines");
        CARRE.set("Four of a kind");
        SUITE.set("Hundred");
        ANNONE.set("Fifty");
        TIERCE.set("Tierce");
        YOU.set("You");
        ...
        PLAYED_CAPOT.set("Played capot");
        PTS_DONE.set("Points done");
        TOTAL_PTS_DONE.set("Total points done");
        DECLARATIONS.set("Declarations");
        TOTAL.set("Total");
        RESULT.set("Result");
        FAILED.set("Failed");
        ...
        REASONS_1.set("Buyer didn't reach bid points!");
        REASONS_2.set("Defender got more points!");
        REASONS_3.set("Capot bid failed!");
        DEFENDER_CAPOT.set("Defender capot");
        COINCHE_WIN_BONUS.set("Coinche win bonus");
        COINCHE_FAIL_PENALTY.set("Coinche fail penalty");
        CONTRACT_FAIL_PENALTY.set("Contract fail penalty");
        LOSER_GET_NOTHING.set("Loser gets nothing");
        PTS_CALCULATION.set("Points calculation");
        ROUND_TOTAL.set("Round total");
        MATCH_TOTAL.set("Match total");
    }
